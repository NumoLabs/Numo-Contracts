...
use numo_contracts::interfaces::IVesu::{IStonDispatcher, IStonDispatcherTrait};
use numo_contracts::interfaces::oracle::{IPriceOracleDispatcher, IPriceOracleDispatcherTrait};
use numo_contracts::interfaces::lendcomp::ILendMod;
...
mod tests {
    ...
    use numo_contracts::interfaces::IVesu::{IStonDispatcher};
